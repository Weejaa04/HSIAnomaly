...
from scripts.bocknet.model import BockNet
from scripts_agri.bocknet.data import get_food_data
from scripts.bocknet.utils import SEED_DICT, UniversalEarlyStopping
    ...
    **kwargs,
    ...
    if not retrain and os.path.exists(model_path):
        ...
        while not early_stopper.early_stop:
            ...
            # Calculate loss only on Train Block (Y[12.5%:50%])
            ...
            # Validation pass - evaluate only on Validation Block (Y[75%:87.5%])
            net.eval()
